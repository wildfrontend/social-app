    ...
    <>
          ...
          options={{
            tabBarButton: () => (
              <Ionicons
                ...
                name={Platform.select({ ios: 'add-circle', android: 'add-circle', default: 'add-circle' }) as any}
                size={40}
      ...
      <Portal>
        ...
        >
          ...
          <Text style={{ color: theme.colors.onSurface, marginTop: 8 }} variant="bodyMedium">
            這是簡單的發佈視窗（示意）。
          </Text>
          <Button style={{ marginTop: 16 }} mode="contained" onPress={() => setComposeOpen(false)}>
            關閉
          </Button>
        </Modal>
      </Portal>
